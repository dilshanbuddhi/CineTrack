...
const SignUp = () => {
    ...
    const inputFocusAnim3 = useSharedValue(0);
    const inputFocusAnim4 = useSharedValue(0);
    ...
    const passwordInputStyle = useAnimatedStyle(() => {
        ...
        return {
            transform: [{ scale: withTiming(inputFocusAnim3.value > 0 ? 1.02 : 1) }],
            borderColor: borderColor,
        };
    });
    ...
    const confirmPasswordInputStyle = useAnimatedStyle(() => {
        ...
        return {
            transform: [{ scale: withTiming(inputFocusAnim4.value > 0 ? 1.02 : 1) }],
            borderColor: borderColor,
        };
    });
                ...
                >
                    ...
                    >
                        <Animated.View style={[{ paddingHorizontal: 24 }, containerStyle]}>
                            ...
                            <Animated.View style={passwordInputStyle}>
                                <View style={{ position: 'relative' }}>
                                    <TextInput
                                        ...
                                        onFocus={() => {
                                            inputFocusAnim3.value = withSpring(1, { damping: 15, stiffness: 100 });
                                        }}
                                        onBlur={() => {
                                            inputFocusAnim3.value = withSpring(0, { damping: 15, stiffness: 100 });
                                        }}
                                    />
                                    <TouchableOpacity
                                        style={{
                            ...
                            <Animated.View style={confirmPasswordInputStyle}>
                                <View style={{ position: 'relative' }}>
                                    <TextInput
                                        style={{
                                            backgroundColor: '#1f2937',
                                        ...
                                        onFocus={() => {
                                            inputFocusAnim4.value = withSpring(1, { damping: 15, stiffness: 100 });
                                        }}
                                        onBlur={() => {
                                            inputFocusAnim4.value = withSpring(0, { damping: 15, stiffness: 100 });
                                        }}
                                    />
                                    <TouchableOpacity
                                        style={{
                            ...
                            >
                                <Text style={{ textAlign: 'center', color: '#9CA3AF', fontSize: 16 }}>
                                    ...
                                    <Text style={{ color: '#e50914', fontWeight: '600' }}>Sign In</Text>
                                </Text>
                            </TouchableOpacity>
                            ...
                            <View style={{ alignItems: 'center', marginTop: 16 }}>
                                <Text style={{ textAlign: 'center', color: '#6B7280', fontSize: 12 }}>
                                    ...
                                    <Text style={{ color: '#e50914' }}>Terms of Service</Text> and{' '}
                                    <Text style={{ color: '#e50914' }}>Privacy Policy</Text>
                                </Text>
                            </View>
